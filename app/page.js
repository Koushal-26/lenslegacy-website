    ...
    <div>
      <main className="bg-black min-h-screen text-white">
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 transform transition-all duration-500 ease-in-out">
          <h1 className="text-5xl md:text-6xl sm:text-6xl font-[800] mb-4 tracking hover:scale-105 duration-500">Creating Life&apos;s Fleeting Moments</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto text-gray-400 hover:scale-105 duration-500">Through a technology, I transform ordinary scenes into extraordinary memories.</p>
        </section>
